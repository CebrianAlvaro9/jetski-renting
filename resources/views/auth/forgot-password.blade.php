@extends('layouts.guest')
    <!-- Session Status -->
    @section('content')
    <section style="background-image:url('{{ asset('images/jetskiCreate.jpeg') }}')" class="bg-center bg-no-repeat bg-gray-200 bg-blend-multiply py-3 items-center justify-center xl:mb-40 mt-3 xl:h-96">
