...
<div id="mod">                         
    ...
    <h5 class="mb-1 mt-6 text-lg font-bold text-blue-900">* En el caso de que se quiera cancelar </h3>
    @error('reason')
    <div class="text-sm text-red-400">{{ $message }}</div>
@enderror
    <div class="mt-6 p-4 flex justify-center ">
        <button id="botoncancel"type="submit"
            class="px-4 py-2 bg-indigo-500 hover:bg-indigo-700 rounded-lg text-white">Cancelar</button>
    </div>
</div>
                   ...
                   <div id="cancel">
                    ...
                    <p>En el caso de querer eliminar la reserva comentanos la razon </p>
                    <form  method="POST" action="{{ route('cancel',['id'=>$jetskisUser->id]) }}"
                        ...
                        <div class="mt-6 p-4">
                            <button type="submit" id="anula"
                                class="px-4 py-2  bg-indigo-900 hover:bg-indigo-700 rounded-lg text-white">Anular el alquiler</button>
                        </div>
                    </form>
                    <div class="mt-6 p-4">
