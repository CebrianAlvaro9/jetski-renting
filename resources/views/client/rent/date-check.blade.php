...
<section class="bg-white py-3 mt-3">
    <div  class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8  ">
        <div class="text-center">
            <h1 class="mb-4 text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl"><span class="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">Comprueba</span> disponibilidad</h1>
            <p class="text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400">Selecciona una hora y fecha y te diremos las motos de agua que tenemos disponibles para ese momento</p>
        </div>
